...
class DANetHead(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer=nn.BatchNorm3d):
        ...
        # self.conv6 = nn.Sequential(nn.Dropout3d(0.1, False), nn.Conv3d(512, out_channels, 1))
        # self.conv7 = nn.Sequential(nn.Dropout3d(0.1, False), nn.Conv3d(512, out_channels, 1))

        self.conv8 = nn.Sequential(nn.Dropout3d(0.1), nn.Conv3d(inter_channels, out_channels, 1))
