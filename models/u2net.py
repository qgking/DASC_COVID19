...
class REBNCONV(nn.Module):
    def __init__(self, in_ch=3, n_classes=3, dirate=1):
        super(REBNCONV, self).__init__()

        self.conv_s1 = nn.Conv2d(in_ch, n_classes, 3, padding=1 * dirate, dilation=1 * dirate)
...
class RSU7(nn.Module):  # UNet07DRES(nn.Module):
    ...
    def __init__(self, in_ch=3, mid_ch=12, n_classes=3):
        super(RSU7, self).__init__()

        self.rebnconvin = REBNCONV(in_ch, n_classes, dirate=1)
...
class U2NETP(nn.Module):
    ...
    def __init__(self, backbone='resnet50', n_channels=3, n_classes=3):
    ...
    def forward(self, x, cam):
        ...
        # return [d0], (d0, d1, d2, d3, d4, d5, d6), None
        return [d0], (d0, d1, d2), None
